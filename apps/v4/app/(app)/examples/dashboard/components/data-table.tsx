      ...
      <form
        onSubmit={(e) => {
          ...
          toast.promise(new Promise((resolve) => setTimeout(resolve, 1000)), {
            loading: `جاري حفظ ${row.original.header}`,
            success: "تم",
            error: "خطأ",
          })
        }}
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            <SelectItem value="outline">المخطط التفصيلي</SelectItem>
            <SelectItem value="past-performance">الأداء السابق</SelectItem>
            <SelectItem value="key-personnel">الكادر الرئيسي</SelectItem>
            <SelectItem value="focus-documents">مستندات التركيز</SelectItem>
          </SelectContent>
        </Select>
        <TabsList className="**:data-[slot=badge]:bg-muted-foreground/30 hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:px-1 @4xl/main:flex">
          <TabsTrigger value="outline">المخطط التفصيلي</TabsTrigger>
          <TabsTrigger value="past-performance">
            الأداء السابق <Badge variant="secondary">3</Badge>
          </TabsTrigger>
          <TabsTrigger value="key-personnel">
            الكادر الرئيسي <Badge variant="secondary">2</Badge>
          </TabsTrigger>
          <TabsTrigger value="focus-documents">مستندات التركيز</TabsTrigger>
        </TabsList>
            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  عرض إجمالي الزوار لآخر 6 أشهر. هذا مجرد نص عشوائي لاختبار التخطيط. يمتد على أسطر متعددة ويجب أن يلتف.
                </div>
              </div>
              <Separator />
            </>
